...
<hr></hr>
 ...
 <?php
    ...
    echo '     <label for="membre">S&eacute;lection du Membre : </label>     <select name="membre" onchange="javascript:submit(this)">     <option value="S&eacutelectionner un membre">S&eacute;lectionner un membre</option>';
...
//si il y a eu sélection dans la liste
    if(isset($_POST["membre"]) && $_POST["membre"]!='S&eacute;lectionner un membre'){
        //on sélectionne tout les membres
...
<label for="pseudo">Pseudo : </label>
        ...
        <option value="0" <?php if($valide_membre==0){ echo "selected='selected'"; }?>>Non valid&eacute;</option>
        <option value="1" <?php if($valide_membre==1){ echo "selected='selected'"; }?>>Valid&eacute;</option>
