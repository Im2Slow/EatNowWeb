...
-- Généré le :  Mer 05 Avril 2017 à 19:53
...
(12, 1, 'Minute Maid Pomme', 'Boisson', 1),
(13, 1, 'Fromage blanc au fruits rouges', 'Dessert', 0),
(14, 1, 'Lipton Ice Tea Pêche', 'Boisson', 1),
(15, 1, 'Compote', 'Fruit', 1.9),
(16, 1, 'Cookie', 'Dessert', 1.5),
(17, 1, 'Donut Nature', 'Dessert', 1.3),
(18, 1, 'Cristaline Gazéifiée 0.5L', 'Boisson', 0),
(19, 1, 'Coca-Cola', 'Boisson', 1),
(20, 1, 'Coca-Cola Light', 'Boisson', 1),
(21, 1, 'Cristaline 1.5cL', 'Boisson', 0),
(22, 1, 'Banane', 'Fruit', 0),
(23, 1, 'Minute Maid Tropical', 'Boisson', 1),
(24, 1, 'Donut Chocolat', 'Dessert', 0),
(25, 1, 'Beignet aux pommes', 'Dessert', 1.5),
(26, 1, 'Brownie', 'Dessert', 1.8),
(27, 1, 'Minute Maid Orange', 'Boisson', 1),
(28, 1, 'Orangina', 'Boisson', 1),
(29, 1, 'Fanta Orange', 'Boisson', 1),
(30, 1, 'Minute Maid Rouge Sensation', 'Boisson', 1),
(31, 1, 'Coca-Cola Zero', 'Boisson', 1),
(32, 2, 'Galette sarrasin aux champignons & lardon', 'Plat', 4.75),
(33, 2, 'Filet de dorade ananas & chataigne', 'Plat', 4.75),
(34, 2, 'Steack Haché', 'Plat', 4.75),
(35, 2, 'Poulet rôti', 'Plat', 4.75),
(36, 1, 'Cookie Michel et Augustin', 'Dessert', 2);
...
(2, 'Henri', 'henri', 'henri.duhamel@devinci.fr', '1', '1', '2017-04-05');
...
(5, 2, 'Formule bleue', 'Plat avec :\r\n1 entrée OU 1 dessert OU 1 boisson', 5);
...
INSERT INTO `orders` (`Number`, `ID Login`, `ID Restaurant`, `ID Menu`, `Payed`) VALUES
(1, 1, 1, 2, 0),
(2, 1, 1, 3, 0),
(3, 1, 1, 5, 0),
(4, 1, 1, 2, 0),
